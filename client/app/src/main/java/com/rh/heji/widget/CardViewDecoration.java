...
//    static RoundRectHelper sRoundRectHelper;
    ...
    public CardViewDecoration(Resources resources, float radius) {

        mShadowStartColor = resources.getColor(R.color.cardview_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.cardview_shadow_end_color);
        mShadowSize = resources.getDimension(R.dimen.dp_1) * SHADOW_MULTIPLIER;
...
//        mPadding = (float) (Math.sqrt((double) mCornerRadius * (double) mCornerRadius * 2) - (double) mCornerRadius);
        ...
        mEdgeShadowPaint.setShader(new LinearGradient(0, -mCornerRadius + mShadowSize, 0, -mCornerRadius - mShadowSize,
                new int[]{Color.WHITE, mShadowStartColor, mShadowEndColor}, null,
                Shader.TileMode.CLAMP));
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int padding16dp = getPadding16dp(resources);
